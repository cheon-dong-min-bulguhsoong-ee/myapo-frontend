...
> = {
    info: {
        surface: 'bg-primary-soft border-primary',
        text: 'text-primary',
    },
    success: {
        surface: 'bg-success-soft border-success',
        text: 'text-success',
    },
    warning: {
        surface: 'bg-warning-soft border-warning',
        text: 'text-warning',
    },
    danger: {
        surface: 'bg-danger-soft border-danger',
        text: 'text-danger',
    },
};
...
function renderIcon(Icon: LucideIcon, textClass: string) {
    return (
        <Icon
            size={16}
            className={`flex-shrink-0 mt-0.5 ${textClass}`}
        />
    );
}
